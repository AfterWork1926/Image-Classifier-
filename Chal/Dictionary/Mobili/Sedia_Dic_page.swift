                ...
                ZStack{
                   ...
                   .frame(width: 328, height: 174)
                            .overlay (
                                ...
                                VStack{ Text("Chair").font(.system(size: 45, design: .rounded)).fontWeight(.bold).foregroundColor(Color("text_color_1"))
                                    Text("Sedia").font(.system(size: 26, design: .rounded)).fontWeight(.semibold).foregroundColor(Color("text_color_2"))
                                }.padding(.bottom, 15)
                            )
                }
                VStack {
                       
                    Image("Sedia_illustration")
                        .resizable()
...
struct Sedia_Dic_page_Previews: PreviewProvider {
