                ...
                ZStack{
                   ...
                   .frame(width: 328, height: 174)
                            .overlay (
                                ...
                                VStack{ Text("Table").font(.system(size: 45, design: .rounded)).fontWeight(.bold).foregroundColor(Color("text_color_1"))
                                    Text("Tavolo").font(.system(size: 26, design: .rounded)).fontWeight(.semibold).foregroundColor(Color("text_color_2"))
                                }.padding(.bottom, 15)
                            )
                }
                VStack {
                       
                    Image("Tavolo_illustration")
                        .resizable()
...
struct Tavolo_Dic_page_Previews: PreviewProvider {
