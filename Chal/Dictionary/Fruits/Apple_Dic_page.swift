                ...
                ZStack{
                   ...
                   .frame(width: 328, height: 174)
                            .overlay (
                                ...
                                VStack{ Text("Apple").font(.system(size: 45, design: .rounded)).fontWeight(.bold).foregroundColor(Color("text_color_1"))
                                    Text("Mela").font(.system(size: 26, design: .rounded)).fontWeight(.semibold).foregroundColor(Color("text_color_2"))
                                }.padding(.bottom, 15)
                            )
                }
                VStack {
                       
                    Image("Apple_illustration")
                        .resizable()
...
struct Apple_Dic_page_Previews: PreviewProvider {
